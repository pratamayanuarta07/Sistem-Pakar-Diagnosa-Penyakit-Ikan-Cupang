    ...
    <div class="row">
        ...
        <form >
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <?php
                    if (number_format((float)$tingkat_keparahan,2, '.', '') >= 10 && number_format((float)$tingkat_keparahan,2, '.', '') < 50) {
                      echo '<input type="text" value="'.number_format((float)$tingkat_keparahan,2, '.', '').'% (Rendah)" class="form-control" id="inputPassword3" disabled>';
                    }
                    elseif (number_format((float)$tingkat_keparahan,2, '.', '') >= 50 && number_format((float)$tingkat_keparahan,2, '.', '') < 70) {
                      echo '<input type="text" value="'.number_format((float)$tingkat_keparahan,2, '.', '').'% (Sedang)" class="form-control" id="inputPassword3" disabled>';
                    }
                    else{
                      echo '<input type="text" value="'.number_format((float)$tingkat_keparahan,2, '.', '').'% (Tinggi)" class="form-control" id="inputPassword3" disabled>';
                    }
                    ?>
                ...
                <div class="form">
        <a href="<?= base_url('diag')?>" class="submit btn btn-primary" type="submit"name="submit">Diagnosis Lagi</a>
        </div>
              </form>
              </div>
    </div>
